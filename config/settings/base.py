...
ADMINS = [("""jeckonia,daniel""", "jeckonia,daniel@example.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "skillcobra.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "skillcobra.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "skillcobra.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "skillcobra.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "skillcobra API",
    "DESCRIPTION": "Documentation of API endpoints of skillcobra",
    "VERSION": "1.0.0",
...
SYNCPAY_MERCHANT_PAYMENT_URL = env.str(
    "SYNCPAY_MERCHANT_PAYMENT_URL", "http://localhost:8001",
)
